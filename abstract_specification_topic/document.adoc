...
:referenceURLID: http://docs.opengeospatial.org/as/22-???/22-???.html
:comment: ### Author one
...
:keywords: ogcdoc, OGC document, Bounding Box, BBox, envelope, bounding volume, convex hull, standard, specification
