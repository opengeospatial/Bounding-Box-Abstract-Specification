= Abstract specification for bounding boxes
...
:external-id: http://www.opengis.net/doc/AS/bbox/1.0
:comment: ### Identifier embedded into a document type-specific external URL
:referenceURLID: http://docs.opengeospatial.org/as/22-027/22-027.html
:comment: ### Author one
...
:keywords: ogcdoc, OGC document, Bounding Box, BBox, envelope, bounding volume, convex hull, standard, specification, abstract
:comment: ### Semicolon-delimited list of the submitting organizations; mandatory
:submitting-organizations: Met Office; Helyx
